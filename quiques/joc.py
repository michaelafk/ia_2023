...
from quiques.entorn import AccionsBarca, SENSOR, Lloc
...
class Illes(joc.Joc):
    ...
    def percepcio(self) -> entorn.Percepcio:
        return entorn.Percepcio(
            {
                SENSOR.LLOC: self.__localitzacio,
                SENSOR.QUICA_ESQ: self.__illes[Lloc.ESQ]["POLL"],
                SENSOR.LLOP_ESQ: self.__illes[Lloc.ESQ]["LLOP"],
                SENSOR.QUICA_DRETA: self.__illes[Lloc.DRET]["POLL"],
                SENSOR.LLOP_DRETA: self.__illes[Lloc.DRET]["LLOP"],
            }
        )
